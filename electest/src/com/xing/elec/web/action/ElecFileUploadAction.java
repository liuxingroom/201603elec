...
public class ElecFileUploadAction extends BaseAction<ElecFileUpload>{
	...
	/**注入资料图纸管理Service*/
	@Resource(name=ElecFileUploadService.SERVICE_NAME)
	ElecFileUploadService elecFileUploadService;
	...
	*/
	...
	private void initSystemDDL() {
		...
		//图纸类别
		List<ElecSystemDDL> picList=elecSystemDDLService.findSysteDDLListByKeyword("图纸类别");
	...
	*/
	public String download(){
		...
		try {
			...
			//2.使用路径path查找到对应的文件，转化为InputStream
