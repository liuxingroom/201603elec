...
<Script language="javascript">
	...
	/**jquery 对象*/
	/**
		focus() 函数时dom对象的函数 （即：只有dom对象才可以调用）
	*/
		function check_null(){
 ...
 <br>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.sexList" name="sexID" id="sexID" cssStyle="width:155px"
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.postList" name="postID" id="postID" cssStyle="width:155px"
						listKey="ddlCode" listValue="ddlName"
						headerKey="" headerValue="请选择">
			</s:select>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.jctList" name="jctID" id="jctID" cssStyle="width:155px"
						listKey="ddlCode" listValue="ddlName"
						headerKey="" headerValue="请选择" onchange="findJctUnit(this)">
			</s:select>
	...
	<td  align="center"  colSpan="4"  class="ta_01" style="WIDTH: 100%" align="left" bgColor="#f5fafe">
		<input type="button" id="BT_File" name="BT_File" value="打开附件"  style="font-size:12px; color:black; height=22;width=55"   onClick="filedir()">
