           ...
           <table border="0" width="100%" cellspacing="0" cellpadding="0">
               <tr>
                   <td width="30%" rowspan="4">
					   <s:select list="#request.nomap" size="15" name="colname1" 
					   			multiple="true" style="width:200px" id="colname1" 
                   ...
                   <td width="35%" rowspan="4" id="colnameDiv">
	                   ...
	                   <s:select list="#request.map" size="15" name="colname2" id="colname2" multiple="true" 
