...
<HTML>
	<HEAD>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath }/script/mypub.js"></script>
     ...
     function saveDict(){
	      //如果 document.Form1.keyword.value=="jerrynew" 的值为true 表示类型名称一栏存在    否则不存在 
	      if(document.Form1.keyword.value=="jerrynew"){
			...
			<TBODY>
				...
				<tr>
					...
					<td class="ta_01" align="left"  width="30%" >
						...
						<!-- headerKey="jerrynew" headerValue="" 即列表中显示的第一个选项-->
						<!-- 第二种遍历方式 -->
						<s:select list="#request.list"  name="keyword"
 ...
 <TR height=10><td colspan=3></td></TR>
  <tr>
     <td align="center" colspan=3>
     	<!-- 使用权限控制 -->
     	<!-- 从session域中取出  权限组成的字符串   并放到request域中 -->
