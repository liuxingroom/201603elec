...
<html>
 ...
 <body>
    ...
    <s:hidden name="roleflag" value="%{roleflag}"></s:hidden>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="passwordconfirm" id="passwordconfirm" showPassword="true" value="%{logonPwd}" maxlength="25" size="22"></s:password>
		</td>
	</tr>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			...
			<s:textfield name="birthday" id="birthday" maxlength="50" size="20" value="%{birthdayDate}" onClick="WdatePicker()"></s:textfield>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:select list="#request.isDutyList" name="isDuty" id="idDuty"
						listKey="ddlCode" listValue="ddlName"
						cssStyle="width:155px">
			</s:select>
		</td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			...
			<s:textfield name="onDutyDate" id="onDutyDate" maxlength="50" size="20" value="%{onDutyDateDate}" onClick="WdatePicker()"></s:textfield>
			<font color="#FF0000">*</font>
		</td>
		<td align="center" bgColor="#f5fafe" class="ta_01">离职日期：</td>
		<td class="ta_01" bgColor="#ffffff">
			<s:date name="offDutyDate" format="yyyy-MM-dd" var="offDutyDateDate"/>
			<s:textfield name="offDutyDate" id="offDutyDate" maxlength="50" size="20" value="%{offDutyDate}" onClick="WdatePicker()" onblur="checkIsDuty(this)"></s:textfield>
		</td>
	</tr>
	<TR>
		<TD class="ta_01" align="center" bgColor="#f5fafe">备注：</TD>
		<TD class="ta_01" bgColor="#ffffff" colSpan="3">
			<s:textarea name="remark" rows="4" cols="52" cssStyle="WIDTH:92%;">系统管理员</s:textarea>
		</TD>
	</TR>
			...
			<s:if test="elecUserFiles!=null && elecUserFiles.size()>0">
				<s:iterator value="elecUserFiles">
					<a href="#" onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_download.do?fileID=<s:property value="fileID"/>','700','400');">
						...
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:date name="progressTime" format="yyyy-MM-dd"/>
						<br/>
					</a>	
				</s:iterator>
			</s:if>
