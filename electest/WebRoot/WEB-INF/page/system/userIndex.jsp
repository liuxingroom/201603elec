...
/*    function deleteAll(){
  ...
  function deleteAll(){
	 ...
	 var flag = false;
	 /**
	 	each 在遍历时  如果返回的是true 则相当于for循环中的continue（进行下一个循环） 
	 	如果返回的是 false 相当于for循环中的false 退出循环
	 */
		...
		<form id="Form1" name="Form1" action="${pageContext.request.contextPath }/system/elecUserAction_home.do" method="post" style="margin:0px;"> 
			...
			<table cellspacing="1" cellpadding="0" width="90%" align="center" bgcolor="#f5fafe" border="0">
				...
				<tr>
					...
					所属单位：</td>
					<td class="ta_01" >
						<s:select list="#request.list" cssStyle="width:155px" name="jctID" id="jctID" 
				...
				<tr>
					...
					<td class="ta_01" align="right">
						...
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Export" type="button" value="导出" name="BT_Export" 
						 onclick="execlExport()">&nbsp;&nbsp;
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Add" type="button" value="导入" name="BT_Add" 
						 onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_importPage.do','900','700')">&nbsp;&nbsp;
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Add" type="button" value="人员统计（按所属单位统计）" name="BT_Add" 
						 onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_chartUser.do','900','700')">&nbsp;&nbsp;
						<input style="font-size:12px; color:black; height=20;width=80" id="BT_Add" type="button" value="人员统计（按性别统计）" name="BT_Add" 
						 onclick="openWindow('${pageContext.request.contextPath }/system/elecUserAction_chartUserFCF.do','900','700')">&nbsp;&nbsp;
					</td>
				</tr>
