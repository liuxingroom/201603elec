			...
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
		     ...
		     <tr>
		        <td class="ta_01" align="center" bgcolor="#f5fafe" height="22">
		           按文件名称和描述搜素：</td>
		          <td class="ta_01">
		          	<s:textfield name="queryString" size="21" id="queryString" onkeydown="returnMethod()"></s:textfield>
					...
					<s:iterator value="#request.list" status="st">
						<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">
							...
							<td align="center" style="HEIGHT: 21px">
								<a href="${pageContext.request.contextPath }/datachart/elecFileUploadAction_delete.do?seqId=<s:property value="seqId"/>" onclick="return returnConfirm()">
