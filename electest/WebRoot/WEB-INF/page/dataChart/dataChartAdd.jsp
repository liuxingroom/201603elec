	...
	/*  function init(){
	   ...
	   if(projId!=0 || belongTo!=0){
		...
		function init(){
			...
			/**
				下面的设置是为了当上传文件的信息提交后  重定向回到  该界面的时候调用
				效果是：使上传的文件能过显示出来  以及所属单位和 图纸类别能够回显
			*/
		   //获取所属单位和图纸类别的条件
		...
		function overWriteFile(tabName1,tabName2)
		{
			...
			var fileName1,fileName2 ;
			var flag = false;
			//匹配给定索引值得所的元素  $tabName1.find("tr:gt(0)")
							...
							<table cellpadding="0" cellspacing="0" border="0" width="100%">
								<tr>
									...
									<td class="ta_01">
										...
										<s:select list="#request.jctList" name="projId" id="projId" cssStyle="width:160px" 
												onchange="changeList();"
